...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ secure_asset('css/fontawesome-all.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ secure_asset('css/login-style.css') }}">
